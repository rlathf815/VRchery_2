...
public class MagicCirclesFX_ShaderColorGradient : MonoBehaviour {

    public MagicCirclesFX_ShaderProperties ShaderColorProperty = MagicCirclesFX_ShaderProperties._TintColor;

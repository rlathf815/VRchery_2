...
public class MagicCirclesFX_ShaderFloatCurve : MonoBehaviour {

    public MagicCirclesFX_ShaderProperties ShaderFloatProperty = MagicCirclesFX_ShaderProperties._Cutout;
